...
foreach(HTML_FILE ${HTML_FILES})
  add_custom_command(TARGET ImageLibrary-Website POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy ${HTML_FILE} ${CMAKE_BINARY_DIR}/bin/data)
endforeach()

foreach(SCRIPT_FILE ${SCRIPT_FILES})
  add_custom_command(TARGET ImageLibrary-Website POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy ${SCRIPT_FILE} ${CMAKE_BINARY_DIR}/bin/data/scripts)
endforeach()

add_custom_command(TARGET ImageLibrary-Website POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${STYLE_DIRECTORY} ${CMAKE_BINARY_DIR}/bin/data/style)
add_custom_command(TARGET ImageLibrary-Website POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${ASSETS_DIRECTORY} ${CMAKE_BINARY_DIR}/bin/data/assets)